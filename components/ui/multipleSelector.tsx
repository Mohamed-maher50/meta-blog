...
export interface MultipleSelectorProps {
  ...
  withCreate?: boolean;
  onCreate?: (value: Option) => Promise<Option | null>;
}
      ...
      const Item = (
        <CommandItem
          ...
          onSelect={async (value: string) => {
            ...
            if (withCreate) setIsLoading(true);
            setInputValue("");
            ...
            if (!withCreate) {
              ...
              if (createdOption) {
                const newOption = [...selected, createdOption];
    ...
    return (
      ...
      >
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute top-1 z-10 w-full rounded-none border bg-popover text-popover-foreground shadow-md outline-none animate-in"
              onMouseLeave={() => {
