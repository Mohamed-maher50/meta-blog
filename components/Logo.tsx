...
const Logo = ({ className, ...attrs }: HTMLAttributes<HTMLDivElement>) => {
  return (
    <div className={cn("flex items-center gap-2", className)} {...attrs}>
      <svg
        width="36"
        height="36"
        viewBox="0 0 36 36"
      ...
      <div className="dark:text-white flex text-secondary-foreground-900 text-2xl gap-0.5 items-center ">
